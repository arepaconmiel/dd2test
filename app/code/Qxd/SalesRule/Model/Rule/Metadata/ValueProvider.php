 ...
 */
namespace Qxd\SalesRule\Model\Rule\Metadata;
...
use Qxd\SalesRule\Model\Rule as Qxdrule;
...
class ValueProvider extends \Magento\SalesRule\Model\Rule\Metadata\ValueProvider
{
    ...
    public function getMetadataValues(\Magento\SalesRule\Model\Rule $rule)
    {
        ...
        $applyOptions = [
            ...
            ['label' => __('Buy X and Y get Z free (Z is a configurable product)'), 'value' => Qxdrule::BUY_X_AND_Y_GET_CONFIGURABLE_ACTION]
        ];
